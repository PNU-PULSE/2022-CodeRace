...
그리고 과제마왕은 아래 조각에 표시된 것처럼 지역 혹은 조각의 중심에 위치하고 있으며 과제마왕을 처치하지 않고서는 과제 마왕이 위치한 곳을 통과할 수 없다.
마지막으로 Black Mamba가 다시 지도를 찢어버리는 것을 막기 위해, aespa는 초기 상태 혹은 레벨업한지 10일마다 레벨을 올려야 한다.
![piece](./img/piece.png)
